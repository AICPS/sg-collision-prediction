...
# 
#         self.training_filenames = np.concatenate([np.full(y.shape[0], int(fname.split('_')[-1])) for y,fname in zip(self.training_y, self.training_filenames)])
#         self.testing_filenames  = np.concatenate([np.full(y.shape[0], int(fname.split('_')[-1])) for y,fname in zip(self.testing_y, self.testing_filenames)])
